...
<div class="container">
                ...
                <div class="span10 offset1">
                    ...
                    <form  id ="form" class="form-horizontal" action="update.php?id=<?php echo $id?>" method="post">
                      <div class="form-group control-group <?php echo !empty($nameError)?'error':'';?>">
                        <div class="controls">
                      ...
                      <div class="form-group control-group <?php echo !empty($emailError)?'error':'';?>">
                          <div class="controls">
